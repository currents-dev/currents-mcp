...
const zodSchema = z.object({
  ...
  annotations: z
    .string()
    .optional()
    .describe("Filter by test annotations. The parameter value must be a JSON-stringified array of objects: `[{ \"type\": \"string\", \"description\": \"string\" | [\"string\"] or null }]`. description is optional; omit or set to null to match any value for that annotation. Example: [{\"type\":\"owner\",\"description\":[\"John Doe\"]},{\"type\":\"skip\"}]"),
});
