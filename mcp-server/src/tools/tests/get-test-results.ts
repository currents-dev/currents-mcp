...
const zodSchema = z.object({
  ...
  annotations: z
    .string()
    .optional()
    .describe("Filter by test annotations. Pass a JSON-stringified array of objects: [{\"type\": \"string\", \"description\": \"string\" | [\"string\"] or null}]. Omit description or set to null to match any annotation of the given type."),
});
